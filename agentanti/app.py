...
# Inject AdSense script (invisible)
components.html(
    """
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1314268638194293"
     crossorigin="anonymous"></script>
...
female_names = ["Alveena", "Ishal", "Areeba", "Yumna", "Rania", "Eshal", "Aleha", "Faryal", "Sehrish", "Mahira",
                "Zoya", "Minahil", "Ayesha", "Laiba", "Fatima", "Hina", "Komal", "Neha", "Mehwish", "Anum",
                "Sidra", "Maham", "Iqra", "Kinza", "Nimra", "Lubna", "Uzma", "Bushra", "Saba", "Noreen",
                "Rabia", "Afshan", "Tabinda", "Aneeqa", "Sania", "Shiza", "Samreen", "Beenish", "Sahar", "Hira",
                "Sadia", "Kiran", "Ghazala", "Fakhra", "Dua", "Wajiha", "Tahira", "Shumaila", "Khadija", "Humaira"]
...
if st.button("🔍 Find My Match"):
    if name and phone:
        ...
        if matches:
            match = matches[0]
            prompt = f"{name} ({age}) ko {min_age}+ saal ki {'ladki' if gender == 'male' else 'ladka'} ka rishta chahiye. Match mila: {match['name']} ({match['age']}). Sirf Roman Urdu me 2-3 line ka paighaam likho. Zyada personal na ho, bas halka romantic aur narm lehja ho. Hindi bilkul na ho."
